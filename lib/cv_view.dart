import 'package:cv_app_hngx/edit_page.dart';
...
class _CvWiewState extends State<CvWiew> {
  String fullName = "Adeyemi Favour Adetayo";
  String slackUsername = "Adeyemi Favour Adetayo";
  String githubHandle = "favourTy";
  String personalBio =
      "I am a Flutter developer and a dedicated student at Federal University "
       'Oye Ekiti, Nigeria. Proudly a member of the Flutterbytes community'
